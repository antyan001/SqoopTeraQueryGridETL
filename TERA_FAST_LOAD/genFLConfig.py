...
table_name = 'prior_model_score_history' #'lal_db_hist_out' #'ma_cmdm_ma_deal_new' #'lal_db_hist_in'
...
if __name__ == "__main__":
    ...
    if USE_PARTITION_INFO:
        ...
        part_name = 'last_train_dt'
        QUERY = '''select *
                   from {}.{}
                   where {} >= date('2022-02-01')
                '''.format(conn_schema, table_name, part_name)
